...
# Guide to Transposition & Frequency Shifting with CDP

A CDP Workshop by Archer Endrich
+-----------------------------------------------------------------------------------------------+
...
> >   generic name *tswtest.aiff*.
> >
> >
> > - Now run the *tswtest.sh* batch file, which transposes a [single
> >   soundfile](tswd12.aiff) down an octave -- just type `tswtest` at
...
> > |------------------------------|---------------------------|------------------------------|----------------------------------------------------------|
> > | [fexp4.aiff](fexp4.aiff)     | 4 = divisions per 8^ve^   | [fexf4.aiff](fexf4.aiff)     | 4 = number of analysis channels in one frequency band    |
> > | [fexp6.aiff](fexp6.aiff)     | 6 = divisions per 8^ve^   | [fexf6.aiff](fexf6.aiff)     | 6 = number of analysis channels in one frequency band    |
> > | [fexp9.aiff](fexp9.aiff)     | 9 = divisions per 8^ve^   | [fexf9.aiff](fexf9.aiff)     | 9 = number of analysis channels in one frequency band    |
> > | [fexp12.aiff](fexp12.aiff)   | 12 divisions per 8^ve^    | [fexf12.aiff](fexf12.aiff)   | 12 = number of analysis channels in one frequency band   |
> >
> > *Table: -p and -f formant extraction (source is [tswpt.aiff](tswpt.aiff))*
>
...
>
> > The source sound is copied to the generic name
> > [tsw1.aiff](tsw1.aiff). A vocal sound really needs to be used as an
> > input in order to hear the difference regarding the formants. The
> > second sound used for the combinations is copied to the generic name
> > [tsw1-2nd.aiff](tsw1-2nd.aiff).
> >
...
>   [tsw1-1a.aiff](tsw1-1a.aiff)
> - REPITCH TRANSPOSEF Mode 3, time-varying with *glideup.brk* (0.0 0,
>   0.49 0, 0.5 -12, 4.0 24, 4.8 -12) [tsw1-1b.aiff](tsw1-1b.aiff)
>
>
>
>
...
>   amplitude*): 2 0.6, 4 0.8 [tsw1-4.aiff](tsw1-4.aiff)
>
>
>
...
>   point (here, of 1000 Hz) [tsw1-6.aiff](tsw1-6.aiff)
>
>
>
...
>   frequency split point of 1000 Hz [tsw1-7.aiff](tsw1-7.aiff)
>
>
...
>   the 1^st^ sound](tsw1ptrace.aiff), saving directly to a .trn file
...
>   2^nd^](tsw1-2ndptrace.aiff) to a .frq. This we use as the second
>   input to REPITCH COMBINE Mode 1; the first input is the .frq [pitch
>   trace 1^st^](tsw1ptrace.aiff) from the 1^st^ sound.
>
...
>   trace derived from the 2^nd^ soundfile. [tsw1-10.aiff](tsw1-10.aiff)
>
>
>
> combinations 2: use a *processed* .frq as an input to COMBINE
>
> - Number 9 INVERTed the [pitch trace 1^st^](tsw1ptrace.aiff) of the
>   first sound. We can add VIBRATO to this inversion and then COMBINE
>   this new vibrato'd inversion with the [pitch trace
>   2^nd^](tsw1-2ndptrace.aiff) of the second sound. This gives us a
...
>   REPITCH TRANSPOSEF, Mode 4 to form
>   [tsw1-11iva.aiff](tsw1-11iva.aiff), and to the 2^nd^ sound's .ana
>   to form [tsw1-11ivb.aiff](tsw1-11ivb.aiff).
>
>
...
> a [sound](tsw2.aiff) and [raise it](tsw2u12.aiff) an octave in pitch
...
> [transpose](tsw2tvtrn.aiff) by a time-varying breakpoint file (MODIFY
> SPEED, Mode 2) or [accelerate](tsw2accel.aiff) (MODIFY SPEED, Mode 5)
...
> level.
>
> [Rapid vibrato-like fluctuations](tsw2vib.aiff) of the transpositions
...
> (distorted)](tsw2mult.aiff) sound in pitch (DISTORT MULTIPLY, using
> *multiplier* =2). Accumulated multiplications following the harmonic
> series, produce a [similar result](tsw2harm.aiff), but one which may
...
>
> The first sound [tsw2transp.aiff](tsw2transp.aiff) is made by PITCH
...
> variants.
>
> The second sound [tsw2tpose.aiff](tsw2tpose.aiff) is made by REPITCH
...
> [tsw2tposef.aiff](tsw2tposef.aiff) is made by TRANSPOSEF which *does*
...
>   ------------------------------------ ------------------------------------------------------- -------------------- ---------------------------------------
>   [tsw2u12.aiff](tsw2u12.aiff)         transpose by a constant \[**mHmvF**\]                   MODIFY SPEED         **2** *semitone_tr_factor*
>   [tsw2tvtrn.aiff](tsw2tvtrn.aiff)     transpose by a breakpoint file \[**mHmvF**\]            MODIFY SPEED         **2** file: *time semitone_tr_factor*
>   [tsw2accel.aiff](tsw2accel.aiff)     acceleration towards a goaltime \[**mHmvF**\]           MODIFY SPEED         **5** *acceleration* *goaltime*
>   [tsw2vib.aiff](tsw2vib.aiff)         pitch vibrato \[**mHmvF**\]                             MODIFY SPEED         **6** *vib_rate semitone_tr_factor*
>   [tsw2mult.aiff](tsw2mult.aiff)       multiply waveshapes \[**mHmvF**\]                       DISTORT MULTIPLY     **None** *integer_multiplier (2-16)*
>   [tsw2harm.aiff](tsw2harm.aiff)       harmonic multiples of waveshapes \[**mHmvF**\]          DISTORT HARMONIC     **None** *harmonics amplitude* file
>   [tsw2transp.aiff](tsw2transp.aiff)   transpose spectrum by a constant \[**mHmvF**\]          PITCH TRANSP         **4** *frq_split semitone_tr_factor*
>   [tsw2tpose.aiff](tsw2tpose.aiff)     transpose spectrum by a breakpoint file \[**mHmvF**\]   REPITCH TRANSPOSE    **3** with bp file *tsw2brk.brk*
>   [tsw2tposef.aiff](tsw2tposef.aiff)   transpose spectrum by a breakpoint file \[**mHpF**\]    REPITCH TRANSPOSEF   **3** with bp file: *tsw2brk.brk*
>
...
>                                        TYPE
>   ------------------------------------ ----------------- ----------------- ----------------------
>   [tsw3om1.aiff](tsw3om1.aiff)         transpose by a    PITCH OCTMOVE     **1**
>                                        constant                            *'octave'\_factor* =
>                                        \[**mHpF**\]                        2
>
>   [tsw3rtfu12.aiff](tsw3rtfu12.aiff)   transpose         REPITCH           **3** *semitones* = 12
>                                        spectrum by a     TRANSPOSEF
>                                        semitone constant
>                                        \[**mHpF**\]
>
>   [tsw3rtu12.aiff](tsw3rtu12.aiff)     transpose         REPITCH TRANSPOSE **3** *semitones* = 12
>                                        spectrum by a
>                                        semitone constant
>                                        \[**mHmvF**\]
>
>   [tsw3om2.aiff](tsw3om2.aiff)         transpose by a    PITCH OCTMOVE     **1**
>                                        constant                            *'octave'\_factor* =
>                                        \[**mHpF**\]                        3
>
>   [tsw3rtfu19.aiff](tsw3rtfu19.aiff)   transpose         REPITCH           **3** *semitones* = 19
>                                        spectrum by a     TRANSPOSEF
>                                        semitone constant
>                                        \[**mHpF**\]
>
>   [tsw3rtu19.aiff](tsw3rtu19.aiff)     transpose         REPITCH TRANSPOSE **3** *semitones* = 19
>                                        spectrum by a
>                                        semitone constant
>                                        \[**mHmvF**\]
>
>   [tsw3om3.aiff](tsw3om3.aiff)         transpose         PITCH OCTMOVE     **1**
>                                        spectrum by a                       *'octave'\_factor* =
>                                        constant                            4
>                                        \[**mHpF**\]
>
>   [tsw3rtfu24.aiff](tsw3rtfu24.aiff)   transpose         REPITCH           **3** *semitones* = 24
>                                        spectrum by a     TRANSPOSEF
>                                        semitone constant
>                                        \[**mHpF**\]
>
>   [tsw3rtu24.aiff](tsw3rtu24.aiff)     transpose         REPITCH TRANSPOSE **3** *semitones* = 24
>                                        spectrum by
>                                        semitone constant
>                                        \[**mHmvF**\]
>
>   [tsw3om4.aiff](tsw3om4.aiff)         transpose         PITCH OCTMOVE     **3**
>                                        spectrum by a                       *'octave'\_factor* =
>                                        constant                            3
>                                        \[**mHpF**\]                        *bassboost* = 4
>   -----------------------------------------------------------------------------------------------
...
>   SOUND                            DESCRIPTION & TYPE                                  CDP FUNCTION   MODE & PARAMS
>   -------------------------------- --------------------------------------------------- -------------- -----------------------------------------
>   [tsw4ptm1.aiff](tsw4ptm1.aiff)   shift 8^ve^ up, above split point \[**mHmvF**\]     PITCH TRANSP   **1** *frq_split*
>   [tsw4ptm2.aiff](tsw4ptm2.aiff)   shift 8^ve^ down, below split point \[**mHmvF**\]   PITCH TRANSP   **2** *frq_split*
>   [tsw4ptm3.aiff](tsw4ptm3.aiff)   8^ve^ shift up & down \[**mHmvF**\]                 PITCH TRANSP   **3** *frq_split*
>   [tsw4ptm4.aiff](tsw4ptm4.aiff)   pitch shift up, above split point \[**mHmvF**\]     PITCH TRANSP   **4** *frq_split transpose*
>   [tsw4ptm5.aiff](tsw4ptm5.aiff)   pitch shift down, below split point \[**mHmvF**\]   PITCH TRANSP   **5** *frq_split transpose*
>   [tsw4ptm6.aiff](tsw4ptm6.aiff)   pitch shift up & down \[**mHmvF**\]                 PITCH TRANSP   **6** *frq_split transpose1 transpose2*
>
>   : **COMPARATIVE LISTENING 4A. (PITCH TRANSP) QUICK-LISTEN SUMMARY
>   (Source: [tsw4pt.aiff](tsw4pt.aiff))**
> :::
>
> []{#HILITEBAND}
>
...
>
> Our single [soundbyte](tsw4hb1.aiff) for this function uses the
...
>   SOUND                            DESCRIPTION & TYPE                                       CDP FUNCTION    MODE & PARAMS
>   -------------------------------- -------------------------------------------------------- --------------- ------------------------------
>   [tsw4ssm1.aiff](tsw4ssm1.aiff)   shift the whole spectrum \[**noHmvF**\]                  STRANGE SHIFT   **1** *frqshift* (.brk file)
>   [tsw4ssm2.aiff](tsw4ssm2.aiff)   shift the spectrum above the frqdivide \[**noHmvF**\]    STRANGE SHIFT   **2** *frqshift frqdivide*
>   [tsw4ssm3.aiff](tsw4ssm3.aiff)   shift the spectrum below the frqdivide \[**noHmvF**\]    STRANGE SHIFT   **3** *frqshift frqdivide*
>   [tsw4ssm4.aiff](tsw4ssm4.aiff)   shift only within the low-high frqband \[**noHmvF**\]    STRANGE SHIFT   **4** *frqshift frqlo frqhi*
>   [tsw4ssm5.aiff](tsw4ssm5.aiff)   shift only outside the low-high frqband \[**noHmvF**\]   STRANGE SHIFT   **5** *frqshift frqlo frqhi*
>
>   : **COMPARATIVE LISTENING 4B. (STRANGE SHIFT) QUICK-LISTEN SUMMARY
>   (Source: [tsw4ss.aiff](tsw4ss.aiff))**
> :::
>
...
>   SOUND                                  DESCRIPTION & TYPE                                  CDP FUNCTION                MODE & PARAMS
>   -------------------------------------- --------------------------------------------------- --------------------------- -------------------------------------------
>   [tsw5x.aiff](tsw5x.aiff)               exaggerate .frq pitch contour \[**mHmvF**\]         REPITCH EXAG                **5 & 6** *meanpch range contour*
>   [tsw5xi.aiff](tsw5xi.aiff)             & invert .frq pitch contour \[**mHmvF**\]           REPITCH INVERT              **1 & 2** *map* \[0\]
>   [tsw5xiq.aiff](tsw5xiq.aiff)           & quantise .frq pitch contour \[**mHmvF**\]         REPITCH QUANTISE            **1 & 2** *q-set*
>   [tsw5xiqr.aiff](tsw5xiqr.aiff)         & randomise .frq pitch contour \[**mHmvF**\]        REPITCH RANDOMISE           **1 & 2** *maxinterval timestep*
>   [tsw5xiqrs.aiff](tsw5xiqrs.aiff)       & smooth .frq pitch contour \[**mHmvF**\]           REPITCH SMOOTH              **1 & 2** *timeframe* \[millisec\]
>   [tsw5xiqrsp.aiff](tsw5xiqrsp.aiff)     & shift pitch of .frq pitch contour \[**mHmvF**\]   REPITCH PCHSHIFT, COMBINE   **None, 1** *transposition* \[semitones\]
>   [tsw5xiqrspv.aiff](tsw5xiqrspv.aiff)   & add vibrato to .frq pitch contour \[**mHmvF**\]   REPITCH VIBRATO             **2** *vibfrq vibrange*
>
>   : **COMPARATIVE LISTENING 5. (REPITCH Processing Functions)
>   QUICK-LISTEN SUMMARY
>   (Source: [tsw5.aiff](tsw5.aiff))**
> :::
>
>
>
...
>                                                        TYPE
>   ---------------------------------------------------- ----------------- ----------------- -----------------
>   [tsw6cp1by2.aiff](tsw6cp1by2.aiff)                   modify 1 by shape REPITCH COMBINE   **1 and 4**
>                                                        of 2 = 1by2\      and TRANSPOSE
>                                                        i.e., 'pass 1
>                                                        through the shape
>                                                        of 2'
>
>   [tsw6cp2by1.aiff](tsw6cp2by1.aiff)                   modify 2 by shape REPITCH COMBINE   **1 and 4**
>                                                        of 1 = 2by1\      and TRANSPOSE
>                                                        i.e., 'pass 2
>                                                        through the shape
>                                                        of 1'
>
>   [tsw6cp3by2.aiff](tsw6cp3by2.aiff)                   modify 3 by shape REPITCH COMBINE   **1 and 4**
>                                                        of 2 = 3by2\      and TRANSOSE
>                                                        i.e., 'pass 3
>                                                        through the shape
>                                                        of 2'
>
>   [tsw6cp1and1by2.aiff](tsw6cp1and1by2.aiff)           combine 1 & 1     REPITCH COMBINE,  **2, 2 and 4**
...
>                                                        2'
>
>   [tsw6cp1and2by1.aiff](tsw6cp1and2by1.aiff)           combine 1 & 2     REPITCH COMBINE,  **2, 2 and 4**
...
>                                                        1'
>
>   [tsw6cp2and1by2.aiff](tsw6cp2and1by2.aiff)           combine 2 & 1     REPITCH COMBINE,  **2, 2 and 4**
...
>                                                        2'
>
>   [tsw6cp2and2by1.aiff](tsw6cp2and2by1.aiff)           combine 2 & 2     REPITCH COMBINE,  **2, 2 and 4**
...
>                                                        1'
>
>   [tsw6cp1by2and3by2.aiff](tsw6cp1by2and3by2gd.aiff)   combine 1         REPITCH COMBINE   **3 and 4**
...
>   QUICK-LISTEN SUMMARY
>   (Sources: [tsw6cp1.aiff](tsw6cp1.aiff) [tsw6cp2.aiff](tsw6cp2.aiff)
>   [tsw6cp3.aiff](tsw6cp3.aiff))**
>   (Pitch Traces: [tsw6cp1hearfrq.aiff](tsw6cp1hearfrq.aiff)
>   [tsw6cp2hearfrq.aiff](tsw6cp2hearfrq.aiff)
>   [tsw6cp3hearfrq.aiff](tsw6cp3hearfrq.aiff)) {border="1"
>   cellpadding="3"}
> :::
...
1.  ### [Time-varying Transposition]{#TDSPEED}
    ...
    > naming the output [tswglisses.aiff](tswglisses.aiff) and audition
