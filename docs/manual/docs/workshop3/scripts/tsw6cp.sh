...
echo copysfx bellsnd.wav tsw6cp1.wav
copysfx bellsnd.wav tsw6cp1.wav
echo copysfx vocalsnd.wav tsw6cp2.wav
copysfx vocalsnd.wav tsw6cp2.wav
echo copysfx drumsnd.wav tsw6cp3.wav
copysfx drumsnd.wav tsw6cp3.wav
echo 

echo 2. ANALYSE
echo pvoc anal 1 tsw6cp1.wav  tsw6cp1.ana
pvoc anal 1 tsw6cp1.wav  tsw6cp1.ana
echo pvoc anal 1 tsw6cp2.wav tsw6cp2.ana
pvoc anal 1 tsw6cp2.wav tsw6cp2.ana
echo pvoc anal 1 tsw6cp3.wav  tsw6cp3.ana
pvoc anal 1 tsw6cp3.wav  tsw6cp3.ana
echo 
...
echo pvoc synth tsw6cp1hearfrq.ana tsw6cp1hearfrq.wav
pvoc synth tsw6cp1hearfrq.ana tsw6cp1hearfrq.wav
echo BELLSND PITCH TRACE
read -n1 -sp "press any key..."
echo
paplay tsw6cp1hearfrq.wav
echo 

echo pvoc synth tsw6cp2hearfrq.ana tsw6cp2hearfrq.wav
pvoc synth tsw6cp2hearfrq.ana tsw6cp2hearfrq.wav
echo VOCALSND PITCH TRACE
read -n1 -sp "press any key..."
echo
paplay tsw6cp2hearfrq.wav
echo 

echo pvoc synth tsw6cp3hearfrq.ana tsw6cp3hearfrq.wav
pvoc synth tsw6cp3hearfrq.ana tsw6cp3hearfrq.wav
echo DRUMSND PITCH TRACE
read -n1 -sp "press any key..."
echo
paplay tsw6cp3hearfrq.wav
echo 
...
echo pvoc synth tsw6cp1to2.ana tsw6cp1to2.wav
pvoc synth tsw6cp1to2.ana tsw6cp1to2.wav
read -n1 -sp "press any key..."
echo
paplay tsw6cp1to2.wav
echo 
...
echo pvoc synth tsw6cp2to1.ana tsw6cp2to1.wav
pvoc synth tsw6cp2to1.ana tsw6cp2to1.wav
read -n1 -sp "press any key..."
echo
paplay tsw6cp2to1.wav
echo 
...
echo pvoc synth tsw6cp3to2.ana tsw6cp3to2.wav
pvoc synth tsw6cp3to2.ana tsw6cp3to2.wav
read -n1 -sp "press any key..."
echo
paplay tsw6cp3to2.wav
echo 
...
echo pvoc synth tsw6cp1and1to2.ana tsw6cp1and1to2.wav
pvoc synth tsw6cp1and1to2.ana tsw6cp1and1to2.wav
read -n1 -sp "press any key..."
echo
paplay tsw6cp1and1to2.wav
echo 
...
echo pvoc synth tsw6cp1and2to1.ana tsw6cp1and2to1.wav
pvoc synth tsw6cp1and2to1.ana tsw6cp1and2to1.wav
read -n1 -sp "press any key..."
echo
paplay tsw6cp1and2to1.wav
echo 
...
echo pvoc synth tsw6cp2and1to2.ana tsw6cp2and1to2.wav
pvoc synth tsw6cp2and1to2.ana tsw6cp2and1to2.wav
read -n1 -sp "press any key..."
echo
paplay tsw6cp2and1to2.wav
echo 
...
echo pvoc synth tsw6cp2and2to1.ana tsw6cp2and2to1.wav
pvoc synth tsw6cp2and2to1.ana tsw6cp2and2to1.wav
read -n1 -sp "press any key..."
echo
paplay tsw6cp2and2to1.wav
echo 
...
echo pvoc synth tsw6cp1to2and3to2gd.ana tsw6cp1to2and3to2gd.wav
pvoc synth tsw6cp1to2and3to2gd.ana tsw6cp1to2and3to2gd.wav
read -n1 -sp "press any key..."
echo
paplay tsw6cp1to2and3to2gd.wav
echo 

echo to delete these files and use a different input, run tsw6dels.sh
echo then edit the COPYSFX line\(s\) in tsw6.sh to create new generic infile\(s\)
read -n1 -sp "press any key..."
echo
echo 
