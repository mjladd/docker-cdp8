...
echo  AND ANALYSE
echo copysfx vocalsnd.wav tsw4pt.wav
copysfx vocalsnd.wav tsw4pt.wav
echo pvoc anal 1 tsw4pt.wav tsw4pt.ana
pvoc anal 1 tsw4pt.wav tsw4pt.ana
echo 

echo PRE-PROCESSING FOR HILITE BAND - COPY SOURCE TO GENERIC 
echo  AND ANALYSE
echo copysfx vocalsnd.wav tsw4hb.wav
copysfx vocalsnd.wav tsw4hb.wav
echo pvoc anal 1 tsw4hb.wav tsw4hb.ana
pvoc anal 1 tsw4hb.wav tsw4hb.ana
...
echo  AND ANALYSE
echo copysfx drumsnd.wav tsw4ss.wav
copysfx drumsnd.wav tsw4ss.wav
echo pvoc anal 1 tsw4ss.wav  tsw4ss.ana
pvoc anal 1 tsw4ss.wav  tsw4ss.ana
read -n1 -sp "press any key..."
echo
echo DISPLAY ENERGY FOCUS OF ORIGINAL SOUND
...
echo pvoc synth tsw4ptm1.ana tsw4ptm1.wav
pvoc synth tsw4ptm1.ana tsw4ptm1.wav
...
echo pvoc synth tsw4ptm2.ana tsw4ptm2.wav
pvoc synth tsw4ptm2.ana tsw4ptm2.wav
...
echo pvoc synth tsw4ptm3.ana tsw4ptm3.wav
pvoc synth tsw4ptm3.ana tsw4ptm3.wav
...
echo pvoc synth tsw4ptm4.ana tsw4ptm4.wav
pvoc synth tsw4ptm4.ana tsw4ptm4.wav
...
echo pvoc synth tsw4ptm5.ana tsw4ptm5.wav
pvoc synth tsw4ptm5.ana tsw4ptm5.wav
...
echo pvoc synth tsw4ptm6.ana tsw4ptm6.wav
pvoc synth tsw4ptm6.ana tsw4ptm6.wav
...
echo pvoc synth tsw4hb1.ana tsw4hb1.wav
pvoc synth tsw4hb1.ana tsw4hb1.wav
echo rm tsw4hb1.ana
rm tsw4hb1.ana
read -n1 -sp "press any key..."
echo
...
echo pvoc synth tsw4ssm1.ana tsw4ssm1.wav 
pvoc synth tsw4ssm1.ana tsw4ssm1.wav 
...
echo pvoc synth tsw4ssm2.ana tsw4ssm2.wav 
pvoc synth tsw4ssm2.ana tsw4ssm2.wav 
...
echo pvoc synth tsw4ssm3.ana tsw4ssm3.wav 
pvoc synth tsw4ssm3.ana tsw4ssm3.wav 
...
echo pvoc synth tsw4ssm4.ana tsw4ssm4.wav 
pvoc synth tsw4ssm4.ana tsw4ssm4.wav 
...
echo pvoc synth tsw4ssm5.ana tsw4ssm5.wav 
pvoc synth tsw4ssm5.ana tsw4ssm5.wav 
...
echo to delete these files and use a different input, run tsw4dels.sh
echo then edit the COPYSFX line\(s\) in tsw4.sh to create new generic infile\(s\)
read -n1 -sp "press any key..."
echo
echo 
